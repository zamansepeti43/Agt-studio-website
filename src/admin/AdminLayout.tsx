      ...
      <div className="admin-main">
        <header className="admin-topbar">
          <div className="admin-topbar-left">
            <button className="admin-menu-toggle" onClick={() => setSidebarOpen((o) => !o)} aria-label="Menüyü aç/kapat">☰</button>
            <span className="admin-topbar-title">{pageTitle}</span>
          </div>
          <div className="admin-topbar-right">
            <a href="/" target="_blank" rel="noopener noreferrer" className="admin-topbar-site-link">↗ Siteyi Görüntüle</a>
