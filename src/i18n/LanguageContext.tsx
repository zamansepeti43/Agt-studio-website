...
const translations: Record<Language, Dictionary> = {
  tr: {
    ...
    etsyEyebrow: "AGT STUDIO • ETSY", etsyTitle: "Etsy'de Öne Çıkan Dijital Araçlar", etsySubtitle: "AGTStudioCo mağazamızdaki dijital ürünleri keşfedin. Bir ürünü seçtiğinizde doğrudan Etsy ilanına geçebilirsiniz.",
  ...
  en: {
    ...
    etsyEyebrow: "AGT STUDIO • ETSY", etsyTitle: "Featured Digital Tools on Etsy", etsySubtitle: "Explore the digital products in our AGTStudioCo store. Select a product to go directly to its Etsy listing.",
