...
const translations: Record<Language, Dictionary> = {
  tr: {
    ...
    discoverServices: "Hizmetlerimizi Keşfet", digitalSolutions: "Dijital Tasarım ve Yapay Zekâ Çözümleri",
    ...
    etsyEyebrow: "AGT STUDIO • ETSY", etsyTitle: "Etsy Mağazamız", etsySubtitle: "AGTStudioCo mağazamızdaki dijital ürünleri keşfedin. Ürünü seçtiğinizde doğrudan Etsy üzerindeki ilan sayfasına yönlendirilirsiniz.",
  ...
  en: {
    ...
    discoverServices: "Explore Our Services", digitalSolutions: "Digital Design & AI Solutions",
    ...
    etsyEyebrow: "AGT STUDIO • ETSY", etsyTitle: "Our Etsy Store", etsySubtitle: "Explore the digital products in our AGTStudioCo store. Select a product to go directly to its Etsy listing.",
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo(() => ({ language, setLanguage, t: (key: string) => translations[language][key] ?? key }), [language]);
